...
MEMORY_SIZE = 24*31*6*499 # For storing approx 100 episodes worth of data
...
PRICE_PENALTY = 5
ACTIONS = [0.0, 0.5, 1.0]  # OFF, 50%, 100% din puterea pompei
USE_RULES=True
BATTERY_ACTIONS_KW = [-3, -2, -1, 0, 1, 2, 3]  # (-) charge, (+) discharge
N_ACTIONS = len(ACTIONS) * len(BATTERY_ACTIONS_KW)
INPUT_DIMS = 5  # adaugi SOC la state
E_BAT_KWH = 13.5
P_BAT_MAX_KW = 5.0
SOC_MIN = 0.1
SOC_MAX = 0.9
